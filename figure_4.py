...
for index, row in df.iterrows():
    ...
    autocorr_values = [df1['Amplitude'].autocorr(lag=i) for i in range(1, 21)] # calculating autocorrelation for lags from 1 to 20
    ...
    lags = np.arange(1, 21) # lags from 1 to 20
